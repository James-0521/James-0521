...
export default function PageLayout(){
    ...
    <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        ...
        <HelpLink title="Deploy" desc="Instantly deploy your Next.js site to a shareable URL with Vercel." url="https://vercel.com/new?utm_source=create-next-app&utm_medium=appdir-template&utm_campaign=create-next-app"></HelpLink>
      </div>
    )
}